...
public class BombCreatorExample : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        WidgetsMinusButton.OnInteract += delegate () { widgets--; widgets = Mathf.Clamp(widgets, 0, 100); UpdateDisplay(); return false; };
        WidgetsPlusButton.OnInteract += delegate () { widgets += 10; widgets = Mathf.Clamp(widgets, 0, 100); UpdateDisplay(); return false; };
